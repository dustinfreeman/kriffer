...
namespace kfr {
	...
	void KProcessor::add_resolution(Chunk* chunk, int resolution) {
		switch(resolution) {
	...
	void KProcessor::ProcessSkeleton() {
		//TODO ProcessSkeleton
	}

	void KProcessor::ProcessAudio() {
		ULONG cbProduced = 0;
		BYTE *pProduced = NULL;
		DWORD dwStatus = 0;
	...
	std::string KProcessor::get_wav_filename() {
